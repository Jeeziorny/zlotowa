...
- **Budgets:** `get_budget_summary`, `get_active_budget_summary`, `list_budgets`, `create_budget`, `save_budget_categories`, `delete_budget`, `check_budget_overlap`
